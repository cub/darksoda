unBoss = function (x, y, p) {
    ...
    this.lastShoot = darksoda.game.time.now + 2000;
    ...
    update: function () {
        ...
        if (darksoda.game.time.now > this.lastShoot) {
            ...
            if (this.playername === "p1") {
                ...
                darksoda.parasitegroup1.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p1.sprite.x - 25, darksoda.p1.sprite.y));
                darksoda.parasitegroup1.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p1.sprite.x - 50, darksoda.p1.sprite.y));
                darksoda.parasitegroup1.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p1.sprite.x + 25, darksoda.p1.sprite.y));
                darksoda.parasitegroup1.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p1.sprite.x + 50, darksoda.p1.sprite.y));
            } else {
                darksoda.parasitegroup2.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p2.sprite.x, darksoda.p2.sprite.y));
                darksoda.parasitegroup2.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p2.sprite.x - 25, darksoda.p2.sprite.y));
                darksoda.parasitegroup2.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p2.sprite.x - 50, darksoda.p2.sprite.y));
                darksoda.parasitegroup2.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p2.sprite.x + 25, darksoda.p2.sprite.y));
                darksoda.parasitegroup2.add(new unParasite(this.sprite.x, this.sprite.y, darksoda.p2.sprite.x + 50, darksoda.p2.sprite.y));
            }
        }
